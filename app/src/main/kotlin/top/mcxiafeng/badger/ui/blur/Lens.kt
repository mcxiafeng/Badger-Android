...
// Adapted from miuix example Lens.kt — https://github.com/YuKongA/miuix (Apache 2.0).

/**
 * Rounded-rect refraction lens with optional chromatic dispersion.
 *
 * @param refractionHeight 折射高度
 * @param refractionAmount 折射强度
 * @param depthEffect 是否启用深度效果
 * @param chromaticAberration 色散强度。0 = 禁用（使用无色散 shader），典型值 0.1-0.3
 */
